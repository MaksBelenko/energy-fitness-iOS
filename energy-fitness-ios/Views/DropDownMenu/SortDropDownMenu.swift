...
class SortDropDownMenu<T: Hashable>: NSObject, UITableViewDelegate, UITableViewDataSource {
...
//    weak var sortButtonLabelDelegate: SortButtonLabelDelegate?
     ...
     */
    func createDropDownMenu(for sender: UIView, ofSize size: CGSize) -> UIPopoverPresentationController? {
